...
train_pipeline = [
    ...
    dict(type='Collect', keys=['img', 'gt_bboxes', 'gt_labels'],meta_keys=('filename','ori_shape','img_shape','img_norm_cfg','pad_shape','scale_factor'))
]
...
# learning policy similar to cyclic LR
#lr_config = dict(
...
log_level = 'INFO'
work_dir = './work_dirs/cascade_rcnn_x101_32x4d_fpn_1x_RFP_try2'
load_from = None
resume_from = None
workflow = [('train', 1)]
