            ...
            dict(
                ...
                transforms=[
                    ...
                    dict(
                        ...
                        p=0.1),
                    dict(type='HueSaturationValue', hue_shift_limit=30, sat_shift_limit=40, val_shift_limit=30, always_apply=False, p=0.5)
                ],
                bbox_params=dict(
                    type='BboxParams',
                    format='pascal_voc',
...
log_level = 'INFO'
work_dir = './work_dirs/cascade_rcnn_x101_32x4d_fpn_1x_sharedcode_groie_albu_try3'
load_from = None
resume_from = None
workflow = [('train', 1)]
